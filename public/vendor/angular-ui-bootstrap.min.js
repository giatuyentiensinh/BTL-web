    ...
    function c(a) {
      ...
      return angular.forEach(e, function (b, e) {
        ...
        if (f > - 1) {
          ...
          d[f] = '(' + b.regex + ')',
          a[f] = '$';
          for (var g = f + 1, h = f + e.length; h > g; g++) d[g] = '',
          a[g] = '$';
          a = a.join(''),
          c.push({
            index: f,
...
angular.module('ui.bootstrap.position', [
  ...
  function (a, b) {
    ...
    function (a, b, c, d, e, f, g, h) {
      ...
      a.uniqueId = 'datepicker-' + a.$id + '-' + Math.floor(10000 * Math.random()),
      ...
      this.split = function (a, b) {
        for (var c = [
        ]; a.length > 0; ) c.push(a.splice(0, b));
        return c
      },
      a.select = function (b) {
      ...
      return {
        ...
        link: function (b, c, d, e) {
          ...
          function g(a, b) {
            ...
            d = new Date(a),
            e = 0;
            for (d.setHours(12); b > e; ) c[e++] = new Date(d),
          ...
          function h(a) {
            ...
            return b.setMonth(0),
            b.setDate(1),
            Math.floor(Math.round((c - b) / 86400000) / 7) + 1
          }
    ...
    function (a, b, c, d, e, f, g) {
      return {
        ...
        link: function (h, i, j, k) {
          ...
          function m(a) {
            if (a) {
              if (angular.isDate(a) && !isNaN(a)) return k.$setValidity('date', !0),
              a;
    ...
    function (a, b, c, d, e, f) {
      ...
      this.init = function (d) {
        h.$element = d,
        b.isOpen && (g = c(b.isOpen), k = g.assign, a.$watch(g, function (a) {
          i.isOpen = !!a
        }))
      },
    ...
    return {
      createNew: function () {
        ...
        return {
          ...
          keys: function () {
            for (var b = [
            ], c = 0; c < a.length; c++) b.push(a[c].key);
            return b
          },
          top: function () {
            return a[a.length - 1]
      ...
      $get: [
        ...
        function (b, c, d, e, f, g, h) {
          ...
          return k.open = function (b) {
            ...
            if (b = angular.extend({
            }, a.options, b), b.resolve = b.resolve || {
            }, !b.template && !b.templateUrl) throw new Error('One of template or templateUrl options is required.');
            ...
            return l.then(function (a) {
              ...
              b.controller && (i.$scope = d, i.$modalInstance = k, angular.forEach(b.resolve, function (b, c) {
                i[c] = a[j++]
              }), f = g(b.controller, i), b.controllerAs && (d[b.controllerAs] = f)),
              h.open(k, {
                scope: d,
                deferred: e,
                content: a[0],
            ...
            compile: function () {
              ...
              return function (b, c, d) {
                ...
                function v() {
                  ...
                  F(),
                  B = m(a),
                  B.show === B.hide ? c.bind(B.show, f)  : (c.bind(B.show, j), c.bind(B.hide, l))
                }
                var w,
                x,
                y,
          ...
          var C = function (a) {
            ...
            c.when(w.source(i, b)).then(function (c) {
              ...
              if (d && m) if (c.length > 0) {
                x.activeIdx = u ? 0 : - 1,
                x.matches.length = 0;
                for (var e = 0; e < c.length; e++) b[w.itemName] = c[e],
                x.matches.push({
                  id: B(e),
